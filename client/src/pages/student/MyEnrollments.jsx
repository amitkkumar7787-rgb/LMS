...
const MyEnrollments = () => {
  ...
  let {enrolledCourses,calculateCourseDuration,navigate} = useContext(AppContext)
  ...
  return (
    ...
    <div className='md:px-36 px-8 pt-10 pb-10'>
      ...
      <table className='md:table-auto border border-gray-500/20 table-fixed w-full overflow-hidden mt-10'>
